    ...
    <div className="max-w-xl mx-auto px-3 sm:px-0 space-y-6 select-none w-full overflow-x-clip">
      ...
      >
        ...
        >
          ...
          <div className={`absolute inset-0 w-full h-full backface-hidden bg-slate-900 border border-slate-800 hover:border-slate-700 rounded-3xl p-6 sm:p-8 flex flex-col justify-between shadow-2xl transition-all duration-300 ${shouldPulse ? 'highlight-pulse' : ''
            }`}>
