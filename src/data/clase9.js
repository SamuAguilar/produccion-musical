  ...
  sections: [
    {
      ...
      image: {
        url: "/images/clase9/clase9-patron-ajuste-cruz-redoblante.webp",
        comment: "Patrón de apriete cruzado: ajuste simétrico de torres opuestas para evitar deformaciones mecánicas en el aro."
      },
      bulletPoints: [
    ...
    },
    {
      ...
      image: {
        url: "/images/clase9/clase9-configuraciones-parche-bombo.webp",
        comment: "Configuraciones del bombo: abierto sin frontal (ataque puro), con puerto (estándar versátil) y cerrado (cuerpo vintage)."
      },
      bulletPoints: [
    ...
    },
    {
      ...
      image: {
        url: "/images/clase9/clase9-subkick-microfono-bombo.webp",
        comment: "Captura combinada de bombo: micrófono interno para definición de ataque y Subkick exterior para subgraves viscerales."
      },
      bulletPoints: [
